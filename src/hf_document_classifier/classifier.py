...
class HFDocumentClassifier:
    def __init__(
        ...
        if framework == "tf":
            ...
            self.model = AutoModelForSequenceClassification.from_pretrained(model_path, low_cpu_mem_usage=True)
    ...
    def classify_text(self, texts: typing.List[str], batchsize: int = 3) -> typing.List[typing.Dict]:
        results = []
